package com.charles.platform.async.wrapper;

import com.charles.platform.async.callback.DefaultCallback;
import com.charles.platform.async.callback.ICallback;
import com.charles.platform.async.callback.IWorker;
import com.charles.platform.async.exception.SkippedException;
import com.charles.platform.async.executor.timer.SystemClock;
import com.charles.platform.async.worker.DependWrapper;
import com.charles.platform.async.worker.ResultState;
